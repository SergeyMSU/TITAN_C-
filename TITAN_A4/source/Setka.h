...
public:
	...
	// Осредняет поправки к источникам, используя соседние ячейки
	...
	void mas_pogl_Culc_fluid(const double& ex, const double& ey, const double& ez, const string& name);
	// Функция для расчёта флюидного поглащения - нужно считать на основнйо сетке
