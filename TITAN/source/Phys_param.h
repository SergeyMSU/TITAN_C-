...
public:
    ...
    double sglag_TS_k = 0.001;         // Сглаживание на высоких широтах
    double sglag_TS_k_sphere = 0.001; // 0.3;   // Сглаживание в головной и хвостовой части
    // Не может быть больше 1

    bool sglag_HP = true;
    double sglag_HP_k_sphere = 0.00005;      // Сферическое сглиживание в головной части
    double sglag_HP_k = 0.0001;          // Сглаживание не в головной области
