...
public:
    ...
    double B_inf = 0.424753; // 0.420186;           // Значение МОДУЛЯ магнитного поля на бесконечности
    ...
    double rho_p_LISM = 0.205853; // 0.200304;             // Безразмерное давление всей плазмы


    // Характерные параметры
    double R_0 = 9.0; //3.00503;             // Характерный размер 1 а.е.
