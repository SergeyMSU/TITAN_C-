...
Phys_param::Phys_param()
{
    ...
    if (this->is_PUI == true)
    {
        ...
        this->hydrogen_arise_1 << 1, 1,
                                  1, 1,
                                  1, 1;

        this->hydrogen_arise_2.resize(this->num_H, this->num_pui + 1);
        this->hydrogen_arise_2 <<   2, 2,
                                    2, 2,
                                    2, 2;

        this->hydrogen_arise_3.resize(this->num_H, this->num_pui);
        this->hydrogen_arise_3 <<   3,
                                    3,
                                    3;

        this->hydrogen_arise_4.resize(this->num_H, this->num_pui);
        ...
        this->proton_arise_2 << 0, 0,
                                0, 0,
                                0, 0;

        proton_arise_3.resize(this->num_H, this->num_pui);
        this->proton_arise_3 << 0,
                                0,
                                0;

        proton_arise_4.resize(this->num_H, this->num_pui);
